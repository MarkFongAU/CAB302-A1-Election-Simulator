...
public class Candidate {
	...
	public Candidate(String candName, String candParty, String candAbbrev, int voteCount) throws ElectionException {
		if(candName==null || candName==""){
			throw new ElectionException("Candidate name cannot be null or empty");
		}
		if(candParty==null || candParty==""){
			throw new ElectionException("Candidate Party cannot be null or empty");
		}
		if(candAbbrev==null || candAbbrev==""){
			throw new ElectionException("Candidate Abbrev cannot be null or empty");
		}
		if(voteCount<0){
			throw new ElectionException("Vote count cannot be less than 0");
		}
		this.name = candName;
	...
	public String getVoteCountString() {
		String str = Integer.toString(voteCount);
		return str;
	}
